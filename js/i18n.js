...
(function (w) {
  const translations = {
    en: {
      ...
      "calc.currency.name":"Currency Converter","calc.currency.desc":"Approximate static rates — 12 currencies",
      ...
      "dev.jwtenc.name":"JWT Encoder","dev.jwtenc.desc":"Sign a JWT token with HS256 using SubtleCrypto",
    ...
    tr: {
      ...
      "calc.currency.name":"Döviz Çevirici","calc.currency.desc":"Yaklaşık sabit kurlar — 12 para birimi",
      ...
      "dev.jwtenc.name":"JWT Şifreleyici","dev.jwtenc.desc":"HS256 ile JWT imzala — SubtleCrypto kullanır",
